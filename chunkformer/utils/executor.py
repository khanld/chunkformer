...
from chunkformer.utils.common import StepTimer
...
class Executor:
    ...
    def __init__(self, global_step: int = 0, device: torch.device = torch.device("cpu")):
    ...
    def train(
        ...
        with model_context():
            for batch_idx, batch_dict in enumerate(train_data_loader):
                ...
                if (
                    info_dict.get("train_engine", "torch_ddp") in ["torch_ddp", "torch_fsdp"]
