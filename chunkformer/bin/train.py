...
def main():
    ...
    tokenizer = None if model_type in ("classification", "vipvl") else init_tokenizer(configs)
    ...
    for epoch in range(start_epoch, end_epoch):
        ...
        logging.info(
            "Epoch {} Step {} TRAIN info lr {} rank {}".format(
    ...
    if final_epoch is not None and rank == 0:
        ...
        writer.close()
    dist.barrier()  # NOTE(yktian): Ensure all ranks end Train before destroy process group.
